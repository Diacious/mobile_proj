...
import com.example.myapplication.databinding.ActivityBookingDetailsBinding
import com.example.myapplication.data.entities.BookingWithCar
        ...
        lifecycleScope.launch {
            try {
                ...
                if (bookingWithCar != null && carDetailsPartial != null) {
                    ...
                    Picasso.get()
                        .load(car.imageUri)
                        .placeholder(com.example.myapplication.R.drawable.ic_car)
